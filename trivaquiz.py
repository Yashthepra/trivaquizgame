...
class Quiz:
    ...
    def display_result(self):
        ...
        percentage=f"percentage scored:{self.correct/self.data_size*100}"
        # calcultaes the percentage of correct answers
        score = int(self.correct*2)
        result = f"Score:{score} out of {self.data_size*2}"
    ...
    def buttons(self):
        ...
        width=10,bg="black",fg="orange",font=("ariel",12,"italic"))
        ...
        width=7,bg="black", fg="red",font=("ariel",16,"bold"))
    ...
    def display_title(self):
        ...
        title = Label(gui, text="YASHBOSS QUIZ",
        width=50, bg="light blue",fg="Black", font=("ariel", 20, "italic"))
...
gui.title("Triva quiz")
 
# get the data from the json file
with open("C:\\Users\HP\OneDrive\Desktop\data.json") as f:
    data = json.load(f)
